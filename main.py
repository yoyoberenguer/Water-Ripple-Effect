...
if __name__ == '__main__':
    ...
    # print(timeit.timeit('ripple_1(cols, rows)', 'from __main__ import ripple_1, cols, rows', number=100))
    print(timeit.timeit('ripple_2', 'from __main__ import ripple_2', number=1000000))
    print(timeit.timeit('ripple_3', 'from __main__ import ripple_3', number=1000000))
    print(timeit.timeit('ripple_4', 'from __main__ import ripple_4', number=1000000))
